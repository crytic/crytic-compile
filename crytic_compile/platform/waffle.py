...
def compile(crytic_compile, target, **kwargs):
    ...
    for contract in target_all["contracts"]:
        ...
        crytic_compile.srcmaps_init[contract_name] = target_loaded["evm"]["bytecode"]["sourceMap"].split(';')
        crytic_compile.bytecodes_runtime[contract_name] = target_loaded["evm"]["deployedBytecode"]["object"]
        crytic_compile.srcmaps_runtime[contract_name] = target_loaded["evm"]["deployedBytecode"]["sourceMap"].split(';')
